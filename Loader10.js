...
function init()
{
  var popUpHTML = "<div id='masterContainer'></div><script type='text/javascript'>$(document).ready(function(){ ExecuteOrDelayUntilScriptLoaded(mainController.init, 'sp.js');});</script>";
...
//main method
var scripts = [	'//cdn.rawgit.com/Maxeuz/HelloWorld/master/QGenMain.js',
